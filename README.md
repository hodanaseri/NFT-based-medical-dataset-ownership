...
This project is licensed under the MIT License – see the [LICENSE]([LICENSE](https://github.com/hodanaseri/NFT-based-medical-dataset-ownership/blob/main/LICENSE)) file for details.
